...
namespace PirelliReports.Site
{
    public partial class IPxRegion : PirelliMaster
    {
        ...
        protected void btnAceptar_Click(object sender, EventArgs e)
        {
            ...
            string url = "CrystalViewer.aspx?reporte=IPxRegion&ip=" + ip + "&desde=" + pMetodos.ConvertddmmyyyyToyyyymmdd(dpDesde.Text) + "&hasta=" + pMetodos.ConvertddmmyyyyToyyyymmdd(dpHasta.Text)+"&filter="+filter;
