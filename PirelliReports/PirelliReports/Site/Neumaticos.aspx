                ...
                <div class="modal-dialog modal-full-width" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <asp:TextBox runat="server" ID="txtRango" CssClass="form-control" placeholder="Rango"></asp:TextBox>
                            ...
                            <div class="row">
                                 <asp:LinkButton runat="server" ID="btnAceptar" OnClick="btnExportar_Click" class="btn btn-warning">Aceptar</asp:LinkButton>
                            </div>
                    </div>
                </div>
            </div>
