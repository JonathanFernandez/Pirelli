<%@ Page Title="" Language="C#" MasterPageFile="~/Master.Master" AutoEventWireup="true" CodeBehind="ActualizacionMasivaCliente.aspx.cs" Inherits="PirelliReports.Site.ActualizacionMasivaCliente" %>
        ...
        <div class="container-fluid form-pirelli">
            ...
            <div class="col-lg-12" style="overflow: auto; width: 98%; height: 400px">    
                <asp:GridView ID="gvListadoSolicitudes" class="table table-responsive table-bordered table-hover table-striped table-condensed" AutoGenerateColumns="false" runat="server">
                    ...
                    <Columns>
                        <asp:BoundField HeaderText="Codigo de cliente" DataField="CodClie" />
                    </Columns>
                    <Columns>
                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                    ...
                                    <h4 class="page-header modal-title" id="myModalSincro">Actualizacion masiva de clientes
                                    </h4>
                                </div>
