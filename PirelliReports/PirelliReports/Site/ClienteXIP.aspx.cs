...
{
    public partial class ClienteXIP : PirelliMaster
    {
        ...
        protected void btnAceptar_Click(object sender, EventArgs e)
        {
            ...
            string url = "CrystalViewer.aspx?reporte=ClienteXIP&ip=" + ip + "&desde=" + pMetodos.ConvertmmddyyyyToyyyymmdd(dpDesde.Text) + "&hasta=" + pMetodos.ConvertmmddyyyyToyyyymmdd(dpHasta.Text) + "&filter=" + filter;
