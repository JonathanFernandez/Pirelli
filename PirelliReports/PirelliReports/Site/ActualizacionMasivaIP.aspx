<%@ Page Title="" Language="C#" MasterPageFile="~/Master.Master" AutoEventWireup="true" CodeBehind="ActualizacionMasivaIP.aspx.cs" Inherits="PirelliReports.Site.ActualizacionMasivaIP" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="PaginaCentral_ContentPlaceHolder" runat="server">
    ...
    <div id="page-wrapper">
        ...
        <div class="container-fluid form-pirelli">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Actuazalizacion masiva de IP
                    </h1>
                    <ol class="breadcrumb">
                        <li>
                        ...
                        <li class="active">
                            <i class="fa fa-refresh"></i> Actualizacion masiva de IP
                            </li>
                    </ol>
                </div>
                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                    ...
                                    <h4 class="page-header modal-title" id="myModalSincro">Actualizacion masiva de IP
                                    </h4>
                                </div>
