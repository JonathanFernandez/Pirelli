...
namespace PirelliReports.Site
{
    public partial class ClienteXIP : PirelliMaster
    {
        ...
        protected void btnAceptar_Click(object sender, EventArgs e)
        {
            ...
            string url = "CrystalViewer.aspx?reporte=ClienteXIP&ip=" + ip + "&desde=" + pMetodos.ConvertddmmyyyyToyyyymmdd(dpDesde.Text) + "&hasta=" + pMetodos.ConvertddmmyyyyToyyyymmdd(dpHasta.Text) + "&filter=" + filter;
